...
class LogicService:
    ...
    async def list_cards(
        ...
        """List cards based on LLM filtering instead of just length."""
        ...
        try:
            ...
            # Prepare data for LLM filtering
            cards_data = []
            for note in notes:
                fields = note.get("fields", {})
            ...
            # If no filter description provided, return cards in natural deck order
